...
h1. Extra notes
    ...
    The formImage.css file can be altered to apply custom styles to the form images generated.
    If you need to condense yor form this could be an effective way to do it.
